...
while running:
    ...
    if (not js.get_button(1)):
        screen.fill("grey")

    # RENDER YOUR GAME HERE
    text_surface = font.render(str(round(drivetrain.speed,5)) + " " 
                            + str(round(drivetrain.strafe,5)) + " " 
                            + str(round(drivetrain.rotate,5))
                            , False, (0,0,0))
    screen.blit(text_surface, (0,0))



    end = Vector2(center[0] + drivetrain.strafe*circleWidth, center[1] + drivetrain.speed*circleWidth)
    end2 = extendPoint(center.x, center.y, center.x - drivetrain.strafe, center.y - drivetrain.speed, circleWidth)

    pygame.draw.rect(screen, (20,20,70), pygame.Rect(center.x-circleWidth,center.y-circleWidth,circleWidth*2, circleWidth*2))
    pygame.draw.circle(screen, (50,50,50), center, circleWidth)
    pygame.draw.line(screen, (0,0,200), center, end2, 4)
    pygame.draw.line(screen, (200,0,0), center, end, 3)
